...
#
# usage: install.sh
#        curl -sSL https://raw.githubusercontent.com/Walkbase/cloud-init-vmware-guestinfo/master/install.sh | sh -
#

# The repository from which to fetch the cloud-init datasource and config files.
REPO_SLUG="${REPO_SLUG:-https://raw.githubusercontent.com/Walkbase/cloud-init-vmware-guestinfo}"
